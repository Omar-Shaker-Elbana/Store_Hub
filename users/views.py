...
from .forms import UpdateProfileForm, UpdateSettingsForm, UpdateUserForm
    ...
    if request.method == "POST":
        if "logout_btn" in request.POST:
            ...
            update_settings = UpdateSettingsForm(
                request.POST, instance=request.user.usersettings
            )
            ...
            if (
                update_settings.is_valid()
                and update_profile.is_valid()
                and update_user.is_valid()
            ):
